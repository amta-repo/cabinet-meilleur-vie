    ...
    <section id="contact" className="section-padding">
      <div className="container mx-auto">
        <div className="text-center max-w-2xl mx-auto mb-12">
          ...
          <h2 className="mt-2 text-3xl sm:text-4xl font-bold text-foreground">Prenez rendez-vous</h2>
          <p className="mt-3 text-muted-foreground">
            Contactez Cabinet Meilleure Vie à Cotonou pour une consultation confidentielle.
          </p>
        </div>
