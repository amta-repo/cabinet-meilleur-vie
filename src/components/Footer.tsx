        ...
        <div>
          ...
          <ul className="space-y-4 text-sm text-primary-foreground/60">
            ...
            <li className="flex items-center justify-center sm:justify-start gap-3">
              ...
              <a href="tel:+2290167618021" className="hover:text-accent transition-colors">+229 01 67 61 80 21</a>
            </li>
            ...
            <li className="flex items-center justify-center sm:justify-start gap-3">
              ...
              <a href="https://wa.me/2290147771967" target="_blank" rel="noopener noreferrer" className="hover:text-accent transition-colors">WhatsApp</a>
            </li>
          </ul>
        </div>
      </div>
